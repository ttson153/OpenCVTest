...
public class PortraitCameraView extends CameraBridgeViewBase implements PreviewCallback {
            ...
            try {
                ...
                if (sizes != null) {
                    if (mCameraIndex == CAMERA_ID_FRONT) {
                        ...
                        mFrameChain[0] = new Mat(realHeight + (realHeight / 2), realWidth, CvType.CV_8UC1); //the frame chain is still in landscape
                        ...
                        mCameraFrame[0].setFrontCam(true);
                        mCameraFrame[1].setFrontCam(true);
                        ...
                        mCameraFrame[1] = new JavaCameraFrame(mFrameChain[1], mFrameWidth, mFrameHeight);
                        mCameraFrame[0].setFrontCam(false);
                        mCameraFrame[1].setFrontCam(false);
    ...
    private class JavaCameraFrame implements CvCameraViewFrame {
        ...
        public Mat gray() {
            if (mFrontCam) { // if mFrontCam == true we rotate the matrix
        ...
        public Mat rgba() {
            // if mFrontCam == true we rotate the matrix
            if (mFrontCam) {
        ...
        public void setFrontCam(boolean mFrontCam) {
            this.mFrontCam = mFrontCam;
        }
    }
